...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Serie.tick_format'
        db.delete_column(u'reports_serie', 'tick_format')

        # Adding field 'Serie.tick_format1'
        db.add_column(u'reports_serie', 'tick_format1',
                      self.gf('django.db.models.fields.CharField')(default='St', max_length=8),
                      keep_default=False)

        # Adding field 'Serie.tick_format2'
        db.add_column(u'reports_serie', 'tick_format2',
                      self.gf('django.db.models.fields.CharField')(default='St', max_length=8),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Serie.tick_format1'
        db.delete_column(u'reports_serie', 'tick_format1')
    ...
    models = {
        ...
        u'reports.serie': {
            ...
            'tick_format1': ('django.db.models.fields.CharField', [], {'default': "'St'", 'max_length': '8'}),
            'tick_format2': ('django.db.models.fields.CharField', [], {'default': "'St'", 'max_length': '8'}),
