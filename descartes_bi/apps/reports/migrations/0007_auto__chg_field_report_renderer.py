...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Changing field 'Report.renderer'
        db.alter_column(u'reports_report', 'renderer', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Report.renderer'
        db.alter_column(u'reports_report', 'renderer', self.gf('django.db.models.fields.TextField')())
