...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Changing field 'Filter.filter_type'
        db.alter_column(u'reports_filter', 'filter_type', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Filter.filter_type'
        db.alter_column(u'reports_filter', 'filter_type', self.gf('django.db.models.fields.CharField')(max_length=2))
