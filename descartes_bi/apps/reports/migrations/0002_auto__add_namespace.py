...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'reports_namespace', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['reports.Namespace'])),
    ...
    models = {
        ...
        u'reports.namespace': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['reports.Namespace']"}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'view': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['reports.Menuitem']", 'null': 'True', 'blank': 'True'}),
